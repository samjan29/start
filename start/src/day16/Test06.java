...
public class Test06 {
	...
	public void getGroup(String group) {
		...
		// 1. 꺼낼 그룹의 맵을 알아낸다.
		HashMap tmp = (HashMap) groupMap.get(group);
		// 그룹 내에 몇명이 누가 들어있는지 알 수 없으므로 키값만 꺼내와서 
		Set set = tmp.keySet();
		// 꺼내온 키값으로 데이터를 꺼낸다.
		Iterator itor = set.iterator();
		while(itor.hasNext()) {
			String key = (String) itor.next();
			String value = (String) tmp.get(key);	// Collection에는 따로 설정 안하면 Object로 들어감
	...
	public Test06() {
		...
		setFriend("친구", "리사", "010-2222-2222");
		setFriend("친구", "로제", "010-3333-3333");
		setFriend("친구", "지수", "010-4444-4444");
		setFriend("동호회", "둘리", "010-9876-5432");
